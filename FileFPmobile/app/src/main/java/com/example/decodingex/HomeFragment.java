...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.rv_heroes);
...
//
    ...
    private ArrayList<movie> getListData(){
        ...
        String[] name = getResources().getStringArray(R.array.movies_data_name);
        String[] detail = getResources().getStringArray(R.array.movies_data_description);
        String[] tahun = getResources().getStringArray(R.array.movies_data_year);
        String[] durasi = getResources().getStringArray(R.array.movies_data_duration);
        String[] genre = getResources().getStringArray(R.array.movies_data_genres);
        TypedArray foto= getResources().obtainTypedArray(R.array.movies_data_photo);
